            ...
            <div
                ...
                <div className="hero-content justify-center items-center flex-col lg:flex-row-reverse">
                    ...
                    <div className='flex-1 flex flex-col lg:pl-[145px] justify-around'>
                        ...
                        <p className="py-6 text-xl">However not all animals enjoy the grooming <br /> process and many owners find that it <br /> is easier to send their pet to a <br /> professional groomer on a regular basis instead.</p>
                        <label htmlFor="my-modal-3" className="px-[50px] cursor-pointer btn-custom hover:bg-accent hover:scale-110 transition rounded-[67px] normal-case text-xl shadow  py-[18px] w-fit text-white">
